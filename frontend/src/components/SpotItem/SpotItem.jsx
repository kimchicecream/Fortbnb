...
function SpotItem({ spot, children }) {
    ...
    const displayStar = () => {
        if (spot.avgRating === 5) {
            return <img className='star' src='../../../stars/4.6above.png' />
        } else if (spot.avgRating < 5 && spot.avgRating >= 4) {
            return <img className='star' src='../../../stars/4.5below.png' />
        } else if (spot.avgRating < 4 && spot.avgRating >= 3) {
            return <img className='star' src='../../../stars/3.5below.png' />
        } else if (spot.avgRating < 3 && spot.avgRating >= 2) {
            return <img className='star' src='../../../stars/2.5below.png' />
        } else if (spot.avgRating > 0) {
            return <img className='star' src='../../../stars/1.5below.png' />
        }
    }
